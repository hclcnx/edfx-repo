			...
			if (!dojo.byId("manageGroups")) {
				var addGroups = '<div data-dojo-type="dijit/Dialog" data-dojo-id="myDialog" title="Name and Address" style="background: #FFFFFF; border-radius: 5px; padding: 10px !important; border: 1px solid black; width:400px">'+
									'<table><tr><td><h3>Gestion des groupes de la communauté <span id="icxcommunityname"></span></h3></td></tr>'+
										...
										'<div class="dijitReset dijitInputField dijitInputContainer"><input id="icxcommunitymemberadd" onblur="leaveMemberInput()" oninput="changeMemberInput()" autocomplete="off" type="text" class="dijitReset dijitInputInner"><div class="dijitPopup dijitComboBoxMenuPopup" style="visibility: visible; z-index: 1000; height: auto; overflow: visible;">'+
				...
				if (dojo.query("#addAllParentMembersRow") && dojo.query("#addAllParentMembersRow")[0]) {
					...
					require(["dijit/form/FilteringSelect", "dojo/store/JsonRest", "dojo/domReady!"], function(FilteringSelect, JsonRest) {
						...
						var filter = new FilteringSelect({
							name: "dijiticxcommunitymemberadd",
							id: "dijiticxcommunitymemberadd",
							placeHolder: "Select a member",
							store: restStore,
						    searchAttr: "search_text",
						    autoComplete: true,
						    queryExpr: "${0}",
						}, "icxcommunitymemberadd");
					});
