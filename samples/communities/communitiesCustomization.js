	...
	require(["dijit/form/FilteringSelect", "dojo/data/ItemFileReadStore", "dijit/Dialog", "dijit/form/TextBox", "dijit/form/Button", "dojo/domReady!"], function(FilteringSelect, ItemFileReadStore) {
		...
		var addGroupsLink = function() {
			...
			if (!dojo.byId("manageGroups")) {
				var addGroups = '<div data-dojo-type="dijit/Dialog" data-dojo-id="myDialog" title="Name and Address" style="background: #FFFFFF; border-radius: 5px; padding: 10px !important; border: 1px solid black; width:430px">'+
									'<table><tr><td><h3>Gestion des groupes et des membres de la communauté <span id="icxcommunityname"></span></h3></td></tr>'+
										...
										'<tr><td><table style="border:1px solid #c0c0c0; width:95%"><tr><td><b>Ajout d\'un groupe</b></td><td><input id="icxcommunitygroupadd" type="text"></td><td><button class="lotusFormButton" style="padding: 5px 10px 6px 10px; position: relative; top: 2px;" id="icxcommunityadd" onclick="addCommunityGroup();return false;">Ajouter</button></td></tr></table></td></tr>'+
										'<tr><td><table style="border:1px solid #c0c0c0; width:95%"><tr id="icxcommunitygrouplist"><td>Groupes membres de la communauté</td></tr></table>'+
										'<table><tr id="icxcommunitygrouppager"><td></td></tr></table></td></tr>'+
										'<tr><td><div class="dijitDialogPaneActionBar"></div></td></tr>'+
										'<tr><td><table style="border:1px solid #c0c0c0; width:95%"><tr><td><b>Ajout d\'un membre</b></td><td>'+
										...
										'<tr><td><table style="border:1px solid #c0c0c0; width:95%"><tr id="icxcommunitymemberlist"><td>Membres de la communauté</td></tr></table>'+
