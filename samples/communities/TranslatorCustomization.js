...
function closeModal() {
    document.getElementById('edfx-header-translation').innerHTML = ''; document.getElementById('edfx-header-modal').style.display = 'none';
};
...
(function() {
  ...
  dojo.ready(function() {
    ...
    var modalHtml = '<div id="edfx-header-modal" class="edfx-container edfx-modal edfx-black-theme">'+
                      '<div class="edfx-modal-content">'+
                        '<div class= "edfx-modal-title">'+
                          ...
                          '<span class="edfx-close" onclick="document.getElementById('edfx-header-translation').innerHTML = ''; document.getElementById('edfx-header-modal').style.display = 'none';">&times;</span>'+
                        '</div>'+
    ...
    //add header translate button
        btnHtml = '<span id="edfx-header-btn" class="lotusBannerBtn" href="javascript:;">'+local.getString('translate')+'</span>',
        translateBtn = dojo.create('div', {innerHTML: btnHtml}, dojo.query(icMenu)[0], 'first');
    	translateBtn.className = "chat navmenu nav-tooltip stproxy_navbarMenuNonVerse"
