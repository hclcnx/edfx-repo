...
var upload_bd = function (file, i, size) {
	...
	xhr.open("POST", tomcat_url+"/ConnectionsCloud/UploadDocument", false);
	xhr.send(form_data);
};
...
var removeCommunityGroup = function(groupName) {
	...
	dojo.xhrGet({
		url : tomcat_url+"/ConnectionsCloud/RemoveGroup?communityUid="+currentCommunityUuid+"&groupName="+groupName,
		handleAs : "json",
		headers : {
...
var removeCommunityMember = function(memberName, memberEmail) {
	...
	dojo.xhrGet({
		url : tomcat_url+"/ConnectionsCloud/RemoveMember?communityUid="+currentCommunityUuid+"&memberName="+memberName+"&memberEmail="+memberEmail,
		handleAs : "json",
		headers : {
			"Content-Type" : "application/json", "X-IBM-Token" : ibmkey, "userId" : gllConnectionsData.userId, "userName" : gllConnectionsData.userName
		},
...
var addCommunityGroup = function() {
	...
	dojo.xhrGet({
		url : tomcat_url+"/ConnectionsCloud/AddGroup?communityUid="+currentCommunityUuid+"&groupName="+dojo.byId("dijiticxcommunitygroupadd").value,
		handleAs : "json",
		headers : {
			"Content-Type" : "application/json", "X-IBM-Token" : ibmkey, "userId" : gllConnectionsData.userId, "userName" : gllConnectionsData.userName
		},
...
var addCommunityMember = function() {
	...
	dojo.xhrGet({
		url : tomcat_url+"/ConnectionsCloud/AddMember?communityUid="+currentCommunityUuid+"&memberName="+dojo.byId("icxcommunitymemberadd").membername+"&memberEmail="+dojo.byId("icxcommunitymemberadd").membermail,
		handleAs : "json",
		headers : {
			"Content-Type" : "application/json", "X-IBM-Token" : ibmkey, "userId" : gllConnectionsData.userId, "userName" : gllConnectionsData.userName
		},
...
var getCommunityGroups = function() {
	...
	dojo.xhrGet({
		url : tomcat_url+"/ConnectionsCloud/GetGroups?communityUid="+currentCommunityUuid,
		handleAs : "json",
		headers : {
...
var getCommunityMembers = function() {
	...
	dojo.xhrGet({
		url : tomcat_url+"/ConnectionsCloud/GetMembers?communityUid="+currentCommunityUuid,
		handleAs : "json",
		headers : {
			"Content-Type" : "application/json", "X-IBM-Token" : ibmkey
		},
			...
			if (!dojo.byId("manageGroups")) {
				...
				if (dojo.query("#addAllParentMembersRow") && dojo.query("#addAllParentMembersRow")[0]) {
					...
					var stateStore = new ItemFileReadStore({
				        url: tomcat_url+"/ConnectionsCloud/GetDominoGroups?ibmkey="+ibmkey
				    });
